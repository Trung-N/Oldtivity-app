...
public class EventsAdapter extends RecyclerView.Adapter<EventsAdapter.MyViewHolder> {
    ...
    public void viewEvent(View view, Event event){
        ...
        //2:date, 3:host, 4:location, 5:phoneNumber, 6:distance, 7:eventId, 8:MembersCount
        String[] eventString = {event.getTitle(),event.getDescription(),event.getDate(),event.getHost(),event.getLocation(),event.getPhoneNumber(),event.getDistance(),event.getId(), event.getMembersCount()};
